...
public class Problem18 extends AbstractProblem18Problem67 {
    ...
    protected void populateTriangle() {
        ...
        this.getTriangle().put(4, new int[]{20, 04, 82, 47, 65}); // SUPPRESS CHECKSTYLE magicNumber
        this.getTriangle().put(5, new int[]{19, 01, 23, 75, 03, 34}); // SUPPRESS CHECKSTYLE magicNumber
        this.getTriangle().put(6, new int[]{88, 02, 77, 73, 07, 63, 67}); // SUPPRESS CHECKSTYLE magicNumber
        this.getTriangle().put(7, new int[]{99, 65, 04, 28, 06, 16, 70, 92}); // SUPPRESS CHECKSTYLE magicNumber
        ...
        this.getTriangle().put(13, new int[]{63, 66, 04, 68, 89, 53, 67, 30, 73, 16, 69, 87, 40, 31}); // SUPPRESS CHECKSTYLE magicNumber
        this.getTriangle().put(14, new int[]{04, 62, 98, 27, 23, 9, 70, 98, 73, 93, 38, 53, 60, 04, 23}); // SUPPRESS CHECKSTYLE magicNumber
    }
