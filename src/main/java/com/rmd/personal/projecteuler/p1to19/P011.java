...
public class P011 implements Problem {
    ...
    private void defineGrid() {
        ...
        {4, 52, 8, 83, 97, 35, 99, 16, 7, 97, 57, 32, 16, 26, 26, 79, 33, 27, 98, 66}, // SUPPRESS CHECKSTYLE magicNumber
        {88, 36, 68, 87, 57, 62, 20, 72, 3, 46, 33, 67, 46, 55, 12, 32, 63, 93, 53, 69}, // SUPPRESS CHECKSTYLE magicNumber
        {4, 42, 16, 73, 38, 25, 39, 11, 24, 94, 72, 18, 8, 46, 29, 32, 40, 62, 76, 36}, // SUPPRESS CHECKSTYLE magicNumber
        ...
        {1, 70, 54, 71, 83, 51, 54, 69, 16, 92, 33, 48, 61, 43, 52, 1, 89, 19, 67, 48}}); // SUPPRESS CHECKSTYLE magicNumber
    }
